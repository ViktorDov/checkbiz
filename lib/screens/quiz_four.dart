...
class QuestionProjectFour extends StatefulWidget {
  ...
  @override
  State<QuestionProjectFour> createState() => _QQuestionProjectFourState();
}

class _QQuestionProjectFourState extends State<QuestionProjectFour> {
  ...
  Future<void> saveProjectData() async {
    ...
    await SharedPref.saveProject(projectEvaluation, 'P4');
    print('saved');
  }
          ...
          if (_currentQuestionIndex < _questions.length - 1) {
            ...
            showDialog(
              ...
              builder: (context) => AlertDialog(
                ...
                content: const Text('Ви завершили опитування для Р4!'),
                actions: [
                  TextButton(
                    onPressed: () {
                      saveProjectData();
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const QuestionProjectFive(),
                        ),
                      );
                    },
                    child: const Text('ОК'),
